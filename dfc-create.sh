...
message_space 1
message_space 1
message_info "Разворачивание подпроекта 'dfc-site'" 1
message_space 1
(cd $dfc_project_main_folder/dfc-site && sh dfc-create.sh -d1)
message_space 1
message_space 1
message_space 1
...
message_space 1
message_space 1
message_info "Запуск пакета в подпроекте 'dfc-site'" 1
message_space 1
(cd $dfc_project_main_folder/dfc-site && sh dfc-run.sh -d1)
message_space 1
message_space 1
